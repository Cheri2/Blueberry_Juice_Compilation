///draw_text_outlined_forced(x, y, string, text_color, outline_color, [outline_width=1], [detail=8])
// draws even if it's oob
var i, xx, yy, _text, _text_color, _outline_color, _outline_width, _detail, _angle, _x_off, _y_off;
xx = clamp(argument[0],view_xview+string_width(argument[2])/2 + 4,view_xview+800-string_width(argument[2])/2 - 4);
yy = argument[1];
_text = argument[2];
